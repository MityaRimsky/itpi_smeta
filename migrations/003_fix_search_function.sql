-- =====================================================
-- Патч для миграции 003: Исправление функции поиска
-- =====================================================
-- Проблема: функция возвращает price (NULL), нужно price_field
-- Дата: 2026-01-29
-- =====================================================
...
COMMENT ON FUNCTION semantic_search_norm_items IS 'Умный поиск работ с учётом синонимов, опечаток и полнотекстового поиска (исправлено: price_field)';
